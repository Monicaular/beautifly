...
def basket_contents(request):
    ...
    if basket_total < settings.FREE_SHIPPING_THRESHOLD:
        shipping = basket_total * Decimal(settings.STANDARD_SHIPPING_PERCENTAGE)
        free_shipping_delta = settings.FREE_SHIPPING_THRESHOLD - basket_total
    else: 
